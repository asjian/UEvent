        ...
        <TouchableOpacity style={{
            ...
            onPress={onPress}>
                <View style={{padding: 7, flexDirection: 'row', alignItems: 'center'}}>
                    <Text style={{justifyContent: 'center', marginRight: 10, color: '#FFCB05', fontWeight: 'bold', fontSize: 14}}>CREATE</Text>
                    <Image source={require('../assets/check.png')} style={{width: 14, height: 14, tintColor: '#FFCB05', }}/>
                </View>
            </TouchableOpacity>

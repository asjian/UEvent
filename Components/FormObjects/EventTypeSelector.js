        ...
        <SectionedMultiSelect
          ...
          headerComponent = {() => {
            return (
              <View style = {styles.header}>
                <Text style = {styles.headerText}>Categories</Text>
                <Ionicons name = 'ios-close-circle-outline' size = {35} style = {styles.close} onPress = {() => this.SectionedMultiSelect2._toggleSelector()}/>
              </View>
            )
          }}
          styles={{subItemText: {fontSize: 23}, itemIconStyle: {fontSize: 23}, itemText: {fontSize: 23}, modalWrapper: {borderWidth: 2},
                  selectToggle: {padding: 7,}, selectToggleText: {color:this.props.form.values.EventType==null?'#a3a3a3':'black'},
